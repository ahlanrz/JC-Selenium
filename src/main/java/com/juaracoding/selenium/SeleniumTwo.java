...
public class SeleniumTwo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement titleMenu = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]"));
        ...
        System.out.println("Download Checklist");
        delay(2);// delay per event
        ...
        WebElement titleMenuTwo = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]"));
        System.out.println("titleMenu: "+ titleMenuTwo.getText());
